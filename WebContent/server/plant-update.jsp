    ...
    <div class="x-body">
        ...
        <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="text" id="plateMessage" name="plateId" required="" lay-verify="plateId"
                  autocomplete="off" class="layui-input" value="${plate.plateId }">
              </div>
    ...
    <script>
        layui.use(['form','layer'], function(){
          ...
          form.on('submit(edit)', function(data){
            console.log(data);
            $.ajax({
            	url:"${pageContext.request.contextPath}/Plant?op=update",
            	type:"post",
            	data:data.field,
            	dataType:"text",
