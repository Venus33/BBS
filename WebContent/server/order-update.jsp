        ...
        <form class="layui-form">
         <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input" value="${invition.invitationId }">
              </div>
          </div>
          <div class="layui-form-item">
              <label for="username" class="layui-form-label">
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input" value="${invition.invitationMessage }">
              </div>
          </div>
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <select id="plateId" name="plateId" lay-verify="plateId">
             		<c:forEach items="${plist }" var="p">
							<c:if test="${invition.plateId==p.plateId }" var="isOk">
								<option value="${p.plateId }" selected="selected">${p.plateTitle }</option>
							</c:if>
							<c:if test="${!isOk }"><option value="${p.plateId }">${p.plateTitle}</option></c:if>
             		</c:forEach>
             		</select>
				</div>
          </div>
              ...
              <div class="layui-input-inline">
                  <select id="categoryId" name="categoryId" lay-verify="categoryId">
             		<c:forEach items="${category }" var="p">
							<c:if test="${invition.categoryId==p.categoryId }">
								<option value="${p.categoryId }" selected="selected">${p.category }</option>
							</c:if>
							<c:if test="${!isOk }">
