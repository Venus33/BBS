          ...
          <div class="col-md-10 offset-md-1 col-lg-8 offset-lg-2">
            <div class="blog-content-wrap">
              ...
              <div class="blog-author-info">
                <div class="author-img">
                 ...
                 <div class="author-desc">
                  <small>${invition.invitationId}</small>
                  <h5>${invition.userId}</h5>
                  <p>${invition.invitationMessage } </p>
                </div>
              </div>
              <div class="comment-section">
                ...
                <form class="comment-form" action="${pageContext.request.contextPath}/Invitation_ans?op=add" method="post">
                  <h5>请留言</h5>
                  <div class="row">
                    <div class="col-12 col-md-6 mb-4">
                      <input type="hidden" class="form-control" placeholder="回帖人姓名" name="userId" value="${userId}">
                    </div>
                    <div class="col-12 col-md-6 mb-4">
                      <input type="hidden" class="form-control" placeholder="时间" name="invitationId" value="${invition.invitationId}">
                    </div>
                    <div class="col-12 mb-4">
                      <textarea rows="7" class="form-control" placeholder="评论" name="ansMessage"></textarea>
                    </div>
                  </div>
                  <button class="btn btn-solid">评论</button>
                </form>
              </div>
